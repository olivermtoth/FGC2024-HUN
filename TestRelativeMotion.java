...
@TeleOp(name="TestRelativeMotion", group="Pushbot")
public class TestRelativeMotion extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        BHI260AP imu = hardwareMap.get(BHI260AP.class, "imu");
        
        BHI260AP.Parameters parameters = new BHI260AP.Parameters();

        parameters.mode                = BHI260AP.SensorMode.IMU;
        parameters.angleUnit           = BHI260AP.AngleUnit.DEGREES;
        parameters.accelUnit           = BHI260AP.AccelUnit.METERS_PERSEC_PERSEC;
